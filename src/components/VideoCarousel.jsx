import { hightlightsSlides } from "../constans/index.js";
import { useEffect, useRef, useState } from "react";
import gsap from "gsap";
import { pauseImg, playImg, replayImg } from "../utils/index.js";
import { useGSAP } from "@gsap/react"; // не забудьте импортировать GSAP
...
const VideoCarousel = () => {
    ...
    useEffect(() => {
        ...
        if (span[videoId]) {
            ...
            return () => {
                anim.kill(); // Убиваем анимацию при размонтировании
            };
        }
    }, [videoId, startPlay]);
                ...
                {hightlightsSlides.map((list, i) => (
                    <div key={list.id} id="slider" className="sm:pr-20 pr-10">
                        <div className="video-carousel_container">
                            <div className="w-full h-full overflow-hidden flex-container rounded-3xl bg-black">
                                <video
                                    id="video"
                                    playsInline={true}
                                    preload="auto"
