...
import {models, sizes} from "../constans/index.js";
                    ...
                    <div className="mx-auto w-full">
                        ...
                        <div className="flex-center">
                            <ul className="color-container">
                                {models.map((item,i) => (
                                    <li key={i} className="w-6 h-6 rounded-full mx-2 cursor-pointer hover:w-8 hover:h-8 transition-all duration-500"
